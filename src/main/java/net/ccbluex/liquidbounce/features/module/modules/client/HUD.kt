...
object HUD : Module() {
    ...
    val redValue = IntegerValue("Noti1Red", 255, 0, 255)
    val greenValue = IntegerValue("Noti1Green", 255, 0, 255)
    val blueValue = IntegerValue("Noti1Blue", 255, 0, 255)
    val gredValue = IntegerValue("Noti2Red", 255, 0, 255)
    val ggreenValue = IntegerValue("Noti2Green", 255, 0, 255)
    val gblueValue = IntegerValue("Noti2lue", 255, 0, 255)
